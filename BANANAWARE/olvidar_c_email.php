<?php 
	if ($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if (isset($_POST['email'])) {
            ...
            if ($conexion) {
                ...
                if($resultado != false){
					...
					$mensaje   = '<!DOCTYPE html>
								<html lang="en">
									...
									<head>
									    ...
									    <link rel="stylesheet" href="views/css/stylec.css">
									            ...
									            <tr>
									              <td class="td5">
									                ...
									                <div class="col-lge div3">
									                  ...
									                  <p class="p1_1">
									                    <a href="localhost/bananaware/olvidar_c_nueva.php?email='.$para.'" class="link3">
					...
					$headers = "From: BananaWare <bananaware4@gmail.com>";
					...
					if (mail($para,$subject,$mensaje,$headers)) {
						...
						$result['errores'][0]= "problema con el correo";
					}
                    
                }else{
                	$result['errores'][1]="Correo electrónico no encontrado.";
                }
            }
		}else{
			$result = ["result"=>false];
		...
		require('views/olvidar_c_email.view.php');
		// El mensaje
	}
 ?>