...
<body>
    ...
    <section class="form-login">
      <h5> prueba kek </h5>
      <input class="controls" type="text" name="Usuario" value="" placeholder="Correo Electrónico" id="CO">
      <input class="controls" type="text" name="Contrasena" value="" placeholder="Contraseña" id="CD">
      <button onclick="pre_cotizacion()" class="boton--secundario boton--primario1">Iniciar Sesión</button>
