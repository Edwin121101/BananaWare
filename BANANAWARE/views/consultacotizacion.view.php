...
<body>
	<section>
		...
		<div class="details clearfix">
			<div class="data right">
				<div class="title">Despliegue de Información sobre: Cotización</div>
				<div class="date">
					Día de Consulta: 01/10/2021<br>
					Código Postal Origen:<br>
					Cógido Postal Destino: <br>					
				</div>
			</div>			
		</div>
		...
		<div class="details clearfix">
			...
			<div class="client left">
				...
				<label><input type="checkbox" id="cbox1" value="first_checkbox">Lunes</label><br>
				<label><input type="checkbox" id="cbox1" value="first_checkbox">Martes</label><br>
				<label><input type="checkbox" id="cbox1" value="first_checkbox">Miercoles</label><br>
				<label><input type="checkbox" id="cbox1" value="first_checkbox">Jueves</label><br>
				<label><input type="checkbox" id="cbox1" value="first_checkbox">Viernes</label><br>
				<label><input type="checkbox" id="cbox1" value="first_checkbox">Sabado</label><br>
				<a href="tiempos.php"><button class="button button1">Mostrar más sobre los tiempos de llegada</button></a>
				<br><br>
		...
		<div class="container">
			<div class="table-wrapper">
				<table>
					...
					<tbody class="body">
						<tr>
							<td class="no">01</td>
							<td class="desc">Servicios Disponibles para la zona  en la que se ecuentra</td>
							<td class="qty"><select  class="button button 1">
								<option value="value1">Garrick</option>
								<option value="value2" selected>Allen</option>
								<option value="value3">West</option>
							  </select></td>
						...
						<tr>
							<td class="no">02</td>
							<td class="desc">Cargos Inherentes a la Zona de Destino</td>
							<td class="qty">Combustibles <br> Peajes</td>
							<td class="unit">$40.00</td>
							<td class="total">$3,200.00</td>
						</tr>
						<tr>
							<td class="no">03</td>
							<td class="desc">Cargos Opcionales Disponibles</td>
							<td class="qty"><select  class="button button 1">
								<option value="value1">Seguro</option>
								<option value="value2" selected>Fragil</option>
			...
			<div>
				<a href="sucursalbusqueda.php"><button class="button button1">Encontrar sitios de entrega más cercanos</button><br></a>
				<button class="button button1">Realizar envio</button>
			</div>
	...
	<footer>
		<div class="container">
			...
			<div class="end">Esta consulta solo describe los elementos obtenidos por el código postal, si desea realizar el envio de clic en iniciar pago.</div>
		</div>
	</footer>
